...
type UploadDto struct {
	Name string `gorm:"index:,unique;not null" json:"name,omitempty"` // the unique name of the file

	DisplayName string `json:"displayName,omitempty"`
	Url         string `json:"url"`                  // the url which we will get this file
	UserID      string `json:"user_id,omitempty"`    // the id of the user who uploaded the file
	CompanyID   string `json:"company_id,omitempty"` // the id of the user who uploaded the file
...
type UploadFilter struct {
	...
	ParentImg string       `query:"parent_img"`
